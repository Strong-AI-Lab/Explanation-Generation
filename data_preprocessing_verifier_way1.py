...
for i in range(3):
    for index, row in total_questions[i].iterrows():
        ...
        total_list[i].append({
            "instruction": "As an explanation verification expert, can you generate the rating score for the given explanation?",
            "input": explanation,
            "output": avg_rating
        })
...
with open('./Paul_new_data/Cardiff_Sydney_merged_verifier_way_1.json', "w") as f:
