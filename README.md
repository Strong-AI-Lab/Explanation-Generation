...
This is the official code repository for our paper [Exploring Iterative Enhancement for Improving Learnersourced Multiple-Choice Question Explanations with Large Language Models](https://ojs.aaai.org/index.php/AAAI/article/view/35164) which has been accepted by the Proceedings of the AAAI Conference on Artificial Intelligence 2025.
...
If you are interested in using the PeerWise dataset referenced in this paper, please email [Qiming Bao](bqmbill714@gmail.com) to request a copy. Please note that the data is for your personal use only and must not be shared with others.
