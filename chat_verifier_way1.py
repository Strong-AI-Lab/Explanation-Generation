...
if flag == "Qiming-Alpaca":
    ...
    # load_model_name = "./qiming_llama_7B_Cardiff_Sydney_merged_verifier_way_1/"
    load_model_name = "./qiming_alpaca_7B_Cardiff_Sydney_merged_verifier_way_1/"
...
def explanationVerifier(generator_response):
    # invitation = "Qiming-Alpaca: "
    # human_invitation = "User: "
    ...
    fulltext = "Instruction: As an explanation verification expert, can you generate the rating score for the given explanation? \n\n" + \
        "\n\n".join([generator_response]) + "\n\n" + invitation
